...
const Hero = () => {
  return (
    <div
      className="flex flex-row flex-wrap items-center justify-center w-10/12 min-h-screen lg:flex-nowrap lg:py-20 lg:space-y-20 lg:space-x-12 xl:space-x-0"
      id="hero"
    >
      <div className="flex flex-col items-start justify-center space-y-5 md:space-y-7 lg:w-1/2 xl:w-auto lg:space-y-10">
        <p className="text-4xl font-bold font-dosis md:text-5xl xl:text-6xl text-gray ">
